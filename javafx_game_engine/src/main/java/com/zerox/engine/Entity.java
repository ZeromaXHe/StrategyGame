...
/**
 * @Author: zhuxi
 * @Time: 2021/10/26 20:11
 * @Description: 参考 https://github.com/edencoding/javafx-game-dev/blob/master/SpaceShooter/src/main/java/com/edencoding/models/Entity.java
 * @ModifiedBy: zhuxi
 */
public class Entity {
